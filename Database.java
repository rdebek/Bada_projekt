...
public class Database {
    ...
    public static void main(String[] args) throws SQLException, NoSuchAlgorithmException {
        ...
        // System.out.println(bazadanych.getTables());
        // System.out.println(bazadanych.select("*", "USERS" ,""));
        //  bazadanych.getTable("USERS");

        System.out.println(bazadanych.md5Hash("password"));
    ...
    public void createTable(ArrayList<JTextField> nazwyKolumn, ArrayList<JTextField> ArgumentyTypowDanych, ArrayList<JComboBox<String>> listaZTypamiDanych, JTextField nazwaTabeli) throws SQLException {
        ...
        for (int i = 1; i < nazwyKolumn.size(); i++) {
            ...
            myStmt.executeUpdate("ALTER TABLE " + nazwaTabeli.getText() + " ADD " + nazwyKolumn.get(i).getText() + " " + p);
        }
